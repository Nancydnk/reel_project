...
# Slide 3: ใส่ CSS Keyframe ให้หลอดกราฟค่อยๆ วิ่งทีละอัน (Sequential Animation)
s3 = """<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<style>
  ...
  .b1 { animation-name: fill1; animation-delay: 0.3s; background: linear-gradient(90deg, #38bdf8, #818cf8); }
  .b2 { animation-name: fill2; animation-delay: 1.6s; background: linear-gradient(90deg, #f43f5e, #fb7185); }
  .b3 { animation-name: fill3; animation-delay: 2.9s; background: linear-gradient(90deg, #c084fc, #e879f9); }
...
with open('slides/slide_1.html', 'w', encoding='utf

cd ~/Desktop/reel_project

cat << 'EOF' > make_vibrant_reel.py
import os
import subprocess
import asyncio
import imageio_ffmpeg
